...
export type TranscriptFormat = 'original-jsonl' | 'changed-format';
export interface NormalizedEvent { type: EventType; rawType: string; timestamp: string; sessionId: string; messageId?: string; data: Record<string, unknown>; sourceFormat: TranscriptFormat; }
